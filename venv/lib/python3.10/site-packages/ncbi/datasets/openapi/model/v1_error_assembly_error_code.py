...
class V1ErrorAssemblyErrorCode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "UNKNOWN_ASSEMBLY_ERROR_CODE", must be one of ["UNKNOWN_ASSEMBLY_ERROR_CODE", "INVALID_BIOPROJECT_IDS", "NO_ASSEMBLIES_FOR_BIOPROJECTS", "INVALID_TAXON", "MISSING_SEARCH_FIELD", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "UNKNOWN_ASSEMBLY_ERROR_CODE", must be one of ["UNKNOWN_ASSEMBLY_ERROR_CODE", "INVALID_BIOPROJECT_IDS", "NO_ASSEMBLIES_FOR_BIOPROJECTS", "INVALID_TAXON", "MISSING_SEARCH_FIELD", ]  # noqa: E501
