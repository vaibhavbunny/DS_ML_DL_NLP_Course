...
class V1reportsLinkedAssemblyLinkedAssemblyType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "LINKED_ASSEMBLY_TYPE_UNKNOWN", must be one of ["LINKED_ASSEMBLY_TYPE_UNKNOWN", "alternate_pseudohaplotype_of_diploid", "principal_pseudohaplotype_of_diploid", "maternal_haplotype_of_diploid", "paternal_haplotype_of_diploid", "haplotype_1", "haplotype_2", "haplotype_3", "haplotype_4", "haploid", ]  # noqa: E501
